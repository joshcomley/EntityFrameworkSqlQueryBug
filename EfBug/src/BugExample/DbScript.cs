namespace BugExample
{
	...
	{
		public static string InstantiateSql = @"-- GENERATED BY DatabaseCreator.cs
...
END
CREATE DATABASE [BugExample.App.Data]
GO
...
END
CREATE LOGIN [hyperpragiaLogin] WITH PASSWORD=N'Ho*ncBr@q4IfiB0}99za&2nY!', DEFAULT_DATABASE=[BugExample.App.Data], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
